...
export function AskBaseLogo({ className = '', size = 40 }: AskBaseLogoProps) {
  return (
    <div
      ...
      className={`relative flex items-center justify-center rounded-[28%] bg-white shadow-[0_8px_30px_rgb(203,41,88,0.12)] border border-[#CB2958]/10 overflow-hidden group ${className}`}
    >
